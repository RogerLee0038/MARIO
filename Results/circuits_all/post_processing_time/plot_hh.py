...
func_list_new = ["{}({})".format(func_list_temp[i][10:-2], func_list_temp[i][-2:]) if func_list_temp[i].startswith("MyPutative") else "{}({})".format(func_list_temp[i][1:-2], func_list_temp[i][-2:]) for i in func_map]
...
plt.savefig('hh_linear_time.pdf')
