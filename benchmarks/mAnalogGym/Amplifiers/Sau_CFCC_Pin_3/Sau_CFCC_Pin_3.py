...
class Sau_CFCC:
    def __init__(self, index=0):
        ...
        self.DX = [
            ...
            ('MOSFET_10_1_M_gm2_PMOS', 1.6, 40.0, 1, 8.0, 'NO'),
            ('MOSFET_10_1_W_gm2_PMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_11_1_L_gmf2_PMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_11_1_M_gmf2_PMOS', 1.6, 40.0, 1, 8.0, 'NO'),
            ('MOSFET_11_1_W_gmf2_PMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_15_2_L_gmc_NMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_15_2_M_gmc_NMOS', 1.6, 40.0, 1, 8.0, 'NO'),
            ('MOSFET_15_2_W_gmc_NMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_17_7_L_BIASCM_NMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_17_7_M_BIASCM_NMOS', 1.6, 40.0, 1, 8.0, 'NO'),
            ('MOSFET_17_7_W_BIASCM_NMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_21_2_L_LOAD2_NMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_21_2_M_LOAD2_NMOS', 1.6, 40.0, 1, 8.0, 'NO'),
            ...
            ('MOSFET_7_1_L_gmf1_PMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_7_1_M_gmf1_PMOS', 1.0, 20.0, 1, 4.0, 'NO'),
            ('MOSFET_7_1_W_gmf1_PMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_8_2_L_gm1_PMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_8_2_M_gm1_PMOS', 1.0, 20.0, 1, 4.0, 'NO'),
            ('MOSFET_8_2_W_gm1_PMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('CAPACITOR_0', 2.3e-13, 5.75e-12, 1e-15, 1.15e-12, 'NO'),
