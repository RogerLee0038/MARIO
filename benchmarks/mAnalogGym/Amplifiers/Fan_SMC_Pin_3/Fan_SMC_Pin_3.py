...
class Fan_SMC:
    def __init__(self, index=0):
        ...
        self.DX = [
            ...
            ('MOSFET_11_1_M_gmf2_PMOS', 6.4, 160.0, 1, 32.0, 'NO'),
            ('MOSFET_11_1_W_gmf2_PMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_23_1_L_gm3_NMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_23_1_M_gm3_NMOS', 3.2, 80.0, 1, 16.0, 'NO'),
            ...
            ('MOSFET_0_8_M_BIASCM_PMOS', 3.2, 80.0, 1, 16.0, 'NO'),
            ...
            ('CAPACITOR_0', 1e-12, 2.5e-11, 1e-15, 5e-12, 'NO'),
            ('CURRENT_0_BIAS', 1.2e-05, 0.0001, 1e-07, 6e-05, 'NO'),
        ]
