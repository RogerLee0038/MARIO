...
class Peng_ACBC:
    def __init__(self, index=0):
        ...
        self.DX = [
            ...
            ('MOSFET_24_1_L_gm4_NMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_24_1_M_gm4_NMOS', 1.0, 20.0, 1, 4.0, 'NO'),
            ('MOSFET_24_1_W_gm4_NMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ...
            ('MOSFET_59_1_L_ma1_PMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_59_1_M_ma1_PMOS', 1.0, 20.0, 1, 4.0, 'NO'),
            ('MOSFET_59_1_W_ma1_PMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_9_2_L_gm1_PMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('MOSFET_9_2_M_gm1_PMOS', 1.0, 20.0, 1, 4.0, 'NO'),
            ('MOSFET_9_2_W_gm1_PMOS', 0.5, 5.0, 0.1, 1.0, 'NO'),
            ('CAPACITOR_0', 2e-12, 5e-11, 1e-15, 1e-11, 'NO'),
